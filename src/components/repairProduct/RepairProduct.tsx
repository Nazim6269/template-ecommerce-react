            ...
            <div className="space-y-6">
              ...
              >
                <p className="mb-3 font-medium">
                  What you need to know so that the process of sending the
                  product for service goes smoothly:
                </p>
                <ol className="mb-3 list-outside list-decimal space-y-2 ps-4">
                  <li>
                    You can send the products sold by eMAG for service by
                    completing the product repair form. To service the products
                    sold by eMAG Marketplace partners, follow the steps shown in
                    the pages dedicated to them.
                  </li>
                  <li>
                    Make sure that the product you want to send for service has
                    an electronic warranty certificate (provided by Depanero),
                    which you can find in the My Warranties section of your
                    customer account and in the email you received when
                    completing the order. Then complete the product repair form
                    below.
                  </li>
                  <li>
                    If in the My Warranties section the product appears with a
                    printed warranty certificate (which came in the box,
                    together with the product), provided by the manufacturer,
                    contact one of the authorized services specified in it to
                    benefit from the repair of the product.
                  </li>
                </ol>
                <p>
                  You are already logged in as{" "}
                  <span className="font-medium">Bonnie Green</span>. Click{" "}
                  <a
              ...
              <div className="divide-y divide-gray-200 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm dark:divide-gray-700 dark:border-gray-700 dark:bg-gray-800">
                ...
                <div className="flex items-center gap-8 p-6 sm:items-start lg:items-center">
                  ...
                  <div className="min-w-0 flex-1 gap-14 xl:flex xl:items-center">
                    ...
                    <div className="mt-4 flex shrink-0 flex-col gap-2 sm:flex-row sm:justify-between md:items-center xl:mt-0 xl:flex-col xl:items-start">
                      <dl className="flex items-center gap-2.5">
                        <dt className="text-gray-500 dark:text-gray-400 xl:w-36">
                          Order Number:
                        </dt>
                        <dd className="text-base font-normal text-gray-500 dark:text-gray-400">
                          <a href="#" className="hover:underline">
                ...
                <div className="flex items-center gap-8 p-6 sm:items-start lg:items-center">
                  ...
                  <div className="min-w-0 flex-1 gap-14 xl:flex xl:items-center">
                    <div className="min-w-0 max-w-xl flex-1 gap-6 sm:flex sm:items-center">
                      ...
                      >
                        {" "}
                        Sony Playstation 5 Digital Edition Console with Extra
                        Blue Controller, and White PULSE 3D Headset{" "}
                      </a>
                    </div>
                ...
                <div className="flex items-center gap-8 p-6 sm:items-start lg:items-center">
                  ...
                  <div className="min-w-0 flex-1 gap-14 xl:flex xl:items-center">
                    <div className="min-w-0 max-w-xl flex-1 gap-6 sm:flex sm:items-center">
                      ...
                      >
                        {" "}
                        Xbox Series X Diablo IV Bundle + Xbox Wireless
                        Controller Carbon Black + Dual Controller Charge Docker{" "}
                      </a>
                    </div>
